package com.alawiyaa.githubuserapi.data.remote.response
...
import com.alawiyaa.githubuserapi.data.local.DatabaseContract.NoteColumns.Companion.COMPANY
import com.alawiyaa.githubuserapi.data.local.DatabaseContract.NoteColumns.Companion.FOLLOWERS
import com.alawiyaa.githubuserapi.data.local.DatabaseContract.NoteColumns.Companion.FOLLOWING
import com.alawiyaa.githubuserapi.data.local.DatabaseContract.NoteColumns.Companion.IMAGE
import com.alawiyaa.githubuserapi.data.local.DatabaseContract.NoteColumns.Companion.LOCATION
import com.alawiyaa.githubuserapi.data.local.DatabaseContract.NoteColumns.Companion.LOGIN
import com.alawiyaa.githubuserapi.data.local.DatabaseContract.NoteColumns.Companion.NAME
import com.alawiyaa.githubuserapi.data.local.DatabaseContract.NoteColumns.Companion.REPOSITORY
import com.alawiyaa.githubuserapi.data.local.DatabaseContract.NoteColumns.Companion.TABLE_NAME
import com.alawiyaa.githubuserapi.data.local.DatabaseContract.NoteColumns.Companion._ID
